pipeline {
  agent any
  environment {
    APPSYSID = '0586fcc94752c21008edb6bf016d4358'
    BRANCH = "${BRANCH_NAME}"
    CREDENTIALS = 'ServiceNow'
    DEVENV = 'https://snigdhpdevdemo.service-now.com/'
    TESTENV = 'https://snigdhptestdemo.service-now.com/'
    PRODENV = 'https://snigdhpproddemo.service-now.com/'
